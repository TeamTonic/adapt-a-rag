# source of this code
# https://github.com/stanfordnlp/dspy/blob/main/dspy/experimental/synthetic_data.py
...
dspy.settings.configure(lm=clause_llm, rm=colbertv2_wiki17_abstracts)
...
x = 0 # added for debugging purposes